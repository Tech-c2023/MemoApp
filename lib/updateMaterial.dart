                  ...
                  GestureDetector(
                    onTap:(){
                      ...
                      setState( (){
                        ...
                        Recipe.quantities.removeWhere((key, value) => key == item);
                      });
                    },
                    child: Container(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      controller: TextEditingController(text: Recipe.selectingQuantity),
                    ),
                  ),
                  //　追加ボタン
                  ElevatedButton(
                    onPressed:  (){
                      setState( () {
                        if(!Recipe.materials.keys.contains(Recipe.selectingMaterial) && Recipe.selectingMaterial != 0 && Recipe.selectingQuantity != "") {
                          Recipe.materials.addAll({Recipe.selectingMaterial : widget.items[Recipe.selectingMaterial]!});
                          Recipe.quantities.addAll({Recipe.selectingMaterial : Recipe.selectingQuantity});
